...
export default function Home() {
  return (
    <div className="grid h-screen w-full grid-cols-[240px_1fr]">
      <div className="flex flex-col h-full bg-white border-r dark:bg-zinc-800">
        <div className="flex items-center h-16 px-4 border-b">
          <h1 className="text-lg font-semibold">Dashboard</h1>
        </div>
        <nav className="flex flex-col flex-1 overflow-y-auto px-4 py-2 space-y-2">
          <a
      ...
      <div className="flex flex-col h-full overflow-hidden">
        <header className="flex items-center h-16 px-4 bg-white border-b dark:bg-zinc-800">
          ...
          <div className="relative flex-1 ml-6">
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              className="absolute left-3 top-3 h-5 w-5 text-zinc-500 dark:text-zinc-400"
            >
              <circle cx="11" cy="11" r="8"></circle>
              <path d="m21 21-4.3-4.3"></path>
            </svg>
            <input
              className="flex h-10 rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 w-full pl-10"
        ...
        <div className="flex flex-col flex-1 p-4 overflow-auto">
          <div className="grid grid-cols-3 gap-4 mb-4">
            ...
            <div className="p-4 bg-white rounded-lg shadow dark:bg-zinc-800">
              ...
              <p className="text-2xl">6789</p>
            </div>
            <div className="p-4 bg-white rounded-lg shadow dark:bg-zinc-800">
              <h2 className="text-lg font-semibold mb-2">
                Failed Applications
              </h2>
              <p className="text-2xl">2345</p>
            </div>
          </div>
              ...
              <tbody className="[&amp;_tr:last-child]:border-0">
                <tr className="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                  ...
                  <td className="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">
                    ...
                    <button className="inline-flex items-center justify-center text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-9 rounded-md px-3 ml-2">
                      View
                    </button>
                  </td>
                </tr>
